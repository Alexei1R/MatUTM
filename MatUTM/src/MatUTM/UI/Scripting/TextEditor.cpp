...
#include "../imgui/include/imgui.h" // for imGui::GetCurrentWindow()
...
const TextEditor::Palette & TextEditor::GetDarkPalette()
{
	const static Palette p = { {
			...
			ImColor(33, 33, 33,255), // Background0xff101010
			0xffe0e0e0, // Cursor
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::CPlusPlus()
{
	...
	if (!inited)
	{
		static const char* const cppKeywords[] = {
			"print","def", "and", "break", "do", "", "else", "elseif", "end", "false", "for", "function", "if", "in", "", "local", "nil", "not", "or", "repeat", "return", "then", "true", "until", "while"
